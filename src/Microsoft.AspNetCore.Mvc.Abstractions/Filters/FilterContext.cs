...
namespace Microsoft.AspNetCore.Mvc.Filters
{
    ...
    public abstract class FilterContext : ActionContext
    {
        ...
        /// for filters where when that define an overriding behavior. When multiple filters may apply to the same 
        ...
        /// </para>
        /// <para>
        /// This mechanism for overriding relies and the rules of order and scope that the filter system
